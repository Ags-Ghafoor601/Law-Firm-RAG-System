...
RED_FLAG_RULES = [
    ...
    {
        "id"      : "RF003",
        "pattern" : ["ongoing litigation", "pending litigation",
                     "court order against", "injunction against",
                     "caveat against", "suit pending against",
                     "threatened litigation", "legal dispute pending",
    ...
    {
        "id"      : "RF004",
        "pattern" : ["co-owner without consent", "co owner without consent",
                     "joint owner without consent", "heir without consent",
                     "heirs without consent", "without written consent",
                     "undisclosed co-owner", "undisclosed heir",
                     "third-party interest detected",
                     "inherited co-sharer without"],
